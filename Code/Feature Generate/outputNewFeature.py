...
def main():
    ...
    # files path
    TRAINX_OUTPUT = "../../ML_final_project/train_x_processed.csv"
    TRAINY_OUTPUT = "../../ML_final_project/train_y_processed.csv"
    TEST_X_OUTPUT = "../../ML_final_project/test__x_processed.csv"

    TRAIN_FILE_X1 = "../../ML_final_project/sample_train_x.csv"
    TRAIN_FILE_X2 = "../../ML_final_project/log_train.csv"
    TRAIN_FILE_Y0 = "../../ML_final_project/truth_train.csv"
    TEST__FILE_X1 = "../../ML_final_project/sample_test_x.csv"
    TEST__FILE_X2 = "../../ML_final_project/log_test.csv"

    TRAIN_DATA_Y0 = np.loadtxt(TRAIN_FILE_Y0, delimiter=',')
    ...
    TRAIN_DATA_Y = TRAIN_DATA_Y0[:, (TRAIN_DATA_Y0.shape[1] - 1)]
    TEST__DATA_X = scaler.transform(TEST__DATA_X0)

    outputXFile(TRAINX_OUTPUT, TRAIN_DATA_X)
    outputYFile(TRAINY_OUTPUT, TRAIN_DATA_Y)
